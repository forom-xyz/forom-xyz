          ...
          <div style={{
            ...
            {!showDevLogin ? (
              <>
                {([
                  ...
                  <button
                    key={p.id}
                    disabled
                    title={p.soon ? 'Bient�t disponible' : 'Bient�t disponible'}
                    style={{
              ...
              <form onSubmit={handleSignIn} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <p style={{ margin: 0, fontSize: '11px', color: 'rgba(255,255,255,0.35)', textAlign: 'center', fontFamily: 'monospace' }}>acc�s d�veloppeur</p>
                <input
                  type="text"
